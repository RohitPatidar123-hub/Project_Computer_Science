 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
 ...
 5a1:	a1 38 0a 00 00       	mov    0xa38,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 38 0a 00 00       	mov    %eax,0xa38
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 38 0a 00 00       	mov    %eax,0xa38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67b:	3b 05 38 0a 00 00    	cmp    0xa38,%eax
