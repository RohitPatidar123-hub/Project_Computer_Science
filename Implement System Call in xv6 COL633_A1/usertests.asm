...
00000670 <writetest1>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     6da:	81 fb 8b 00 00 00    	cmp    $0x8b,%ebx
  ...
  n = 0;
    ...
    if(i == 0){
     ...
     73f:	75 cf                	jne    710 <writetest1+0xa0>
      if(n == MAXFILE - 1){
     741:	81 fe 8a 00 00 00    	cmp    $0x8a,%esi
    ...
    39a8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a16:	50                   	push   %eax
    3a17:	56                   	push   %esi
    3a18:	e8 d6 fe ff ff       	call   38f3 <write>
  while(--i >= 0)
    ...
    3a49:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3a80:	50                   	push   %eax
    3a81:	57                   	push   %edi
    3a82:	e8 6c fe ff ff       	call   38f3 <write>
  ...
  write(fd, &c, 1);
    ...
    3af1:	52                   	push   %edx
    3af2:	57                   	push   %edi
    3af3:	e8 fb fd ff ff       	call   38f3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b9a:	52                   	push   %edx
    3b9b:	57                   	push   %edi
    3b9c:	e8 52 fd ff ff       	call   38f3 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cb6:	56                   	push   %esi
    3cb7:	e8 9f fc ff ff       	call   395b <sbrk>
  if(p == (char*)-1)
