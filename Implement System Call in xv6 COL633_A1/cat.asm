 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 534:	ff 24 85 08 08 00 00 	jmp    *0x808(,%eax,4)
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb 00 08 00 00       	mov    $0x800,%ebx
 ...
 651:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 40 0d 00 00       	mov    %eax,0xd40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72b:	3b 05 40 0d 00 00    	cmp    0xd40,%eax
