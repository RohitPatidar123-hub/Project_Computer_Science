...
00000100 <ls>:
{
 ...
 125:	8d b5 d0 fd ff ff    	lea    -0x230(%ebp),%esi
 ...
 152:	8b 95 e0 fd ff ff    	mov    -0x220(%ebp),%edx
 ...
 1f3:	8d 85 c0 fd ff ff    	lea    -0x240(%ebp),%eax
 1f9:	6a 10                	push   $0x10
 1fb:	50                   	push   %eax
 1fc:	53                   	push   %ebx
 ...
 208:	0f 85 7b ff ff ff    	jne    189 <ls+0x89>
      if(de.inum == 0)
 20e:	66 83 bd c0 fd ff ff 	cmpw   $0x0,-0x240(%ebp)
 215:	00 
 216:	74 d8                	je     1f0 <ls+0xf0>
      memmove(p, de.name, DIRSIZ);
 218:	83 ec 04             	sub    $0x4,%esp
 21b:	8d 85 c2 fd ff ff    	lea    -0x23e(%ebp),%eax
 221:	6a 0e                	push   $0xe
 223:	50                   	push   %eax
 ...
 24d:	8b 8d e0 fd ff ff    	mov    -0x220(%ebp),%ecx
 253:	8b 95 d8 fd ff ff    	mov    -0x228(%ebp),%edx
