 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a4:	ff 24 85 74 07 00 00 	jmp    *0x774(,%eax,4)
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 6b 07 00 00       	mov    $0x76b,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 78 0a 00 00       	mov    %eax,0xa78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 78 0a 00 00    	cmp    0xa78,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 720:	00 00 00 
    if(p->s.size >= nunits){
